...
$q1 = "select * from hostel where e_year = 'first year' and  semester = 'first sem' and gender = 'male' and branch = 'information technology' order by percent1 desc";
...
<div class="panel">
    <h1>Boys First Year I.F Records</h1>
