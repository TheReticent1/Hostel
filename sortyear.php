...
if (isset($_POST['fy'])) {
    ...
    $year = 'Boys Hostel First Year Records';
    $fy = true;
    $sy = false;
    $ty = false;
}
if (isset($_POST['sy'])) {
    ...
    $res = mysqli_query($con, $q1);
    $year = 'Boys Hostel Second Year Records';
    $fy = false;
    $sy = true;
    $ty = false;
}
if (isset($_POST['ty'])) {
    $q1 = "select * from hostel where e_year = 'third year' and  semester = 'fifth sem' and gender = 'male'";
    $res = mysqli_query($con, $q1);
    $year = 'Boys Hostel Third Year Records';
    $fy = false;
    $sy = false;
    $ty = true;
}
...
<div class="panel">
    ...
    if ($fy == true && $sy == false && $ty == false) {
        ...
        <form action=\"sortbranch.php\" method=\"post\" style=\"display: flex\">
            <a href=\"AdminPanel.php\" class=\"submit-btn\"
