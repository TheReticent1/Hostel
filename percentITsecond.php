...
$q1 = "select * from hostel where e_year = 'second year' and  semester = 'third sem' and gender = 'male' and branch = 'information technology' order by percent2 desc ";
...
<div class="panel">
    <h1>Boys Second Year I.F Records</h1>
