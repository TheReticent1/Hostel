...
<div class="panel">
    <h1>Girls First Year I.F Records</h1>
    ...
    <div class="sort-btn">
        ...
        <a href="percentITgfirst.php" class="submit-btn" style="text-decoration: none;background: #1DA1F2;font-size: 12px;">Sort by Percentage</a>
    </div>
</div>
